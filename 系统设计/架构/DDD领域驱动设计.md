...
![软件架构模式的演进.png](../../img/架构/DDD/软件架构模式的演进.png)
...
![DDD是如何进行战略设计.png](../../img/架构/DDD/DDD是如何进行战略设计.png)
...
![ddd总结图.png](../../img/架构/DDD/ddd总结图.png)
...
![值对象1.png](../../img/架构/DDD/值对象1.png)

![值对象2.png](../../img/架构/DDD/值对象2.png)
...
![DDD分层架构.png](../../img/架构/DDD/DDD分层架构.png)
...
![三层架构如何演进到DDD分层架构.png](../../img/架构/DDD/三层架构如何演进到DDD分层架构.png)
...
![项目级微服务.png](../../img/架构/DDD/项目级微服务.png)
...
![企业级中台微服务.png](../../img/架构/DDD/企业级中台微服务.png)
...
![ddd中台和微服务协作.png](../../img/架构/DDD/ddd中台和微服务协作.png)
...
![cola架构.png](../../img/架构/DDD/cola/cola架构.png)

![cola架构2.png](../../img/架构/DDD/cola/cola架构2.png)
...
![start层.png](../../img/架构/DDD/cola/start层.png)
...
![adapter层.png](../../img/架构/DDD/cola/adapter层.png)
...
![client层.png](../../img/架构/DDD/cola/client层.png)
...
![app层.png](../../img/架构/DDD/cola/app层.png)
...
![domain层.png](../../img/架构/DDD/cola/domain层.png)
...
![domain层转换.png](../../img/架构/DDD/cola/domain层转换.png)
...
![领域与功能的分包策略.png](../../img/架构/DDD/cola/领域与功能的分包策略.png)

![领域与功能的分包策略2.png](../../img/架构/DDD/cola/领域与功能的分包策略2.png)
...
![infrastructure层.png](../../img/架构/DDD/cola/infrastructure层.png)
